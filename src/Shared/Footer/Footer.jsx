...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-gray-100 text-gray-800 mt-10">
            ...
            <div className="py-6 text-sm text-center text-gray-600">© 2023 Company Co. All rights reserved to Fazlul Karim Hridoy(CEO).</div>
        </footer>
    );
};
